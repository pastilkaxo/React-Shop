...
export default function Favorit({favorite,delFavItem,added ,addToCart,toggleFavContainer,displayMain}) {
        ...
        <div className="wrapper">
            ...
            <div className="card" key={bike.id}>
              <div className="bike-favorite">
                <svg onClick={() => delFavItem(bike.id)} className="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium css-vubbuv" focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="FavoriteBorderIcon" fill="black">
              ...
              <div className="add-tools">
                ...
                <img src={bike.added ? added : './img/add.svg'} alt="add" />
                </span>
              </div>
            </div>
          ))}
