...
import useLengthTracker from "./useLengthTracker";

const Header = ({displayChange,bikes,added, displayMain , toggleFavContainer}) => {

  const {bikesLength , addedLength} = useLengthTracker(bikes,added);
...
<div className="header">
                   ...
                   <div className="links">
                       <span className="cart">
                          <span className="cart-length">{bikesLength}</span>
                          <svg xmlns="http://www.w3.org/2000/svg" onClick={displayChange} width="30" height="30" viewBox="0 0 20 20" fill="none">
                      ...
                      <span className="fav-length">{addedLength}</span>
                      <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 22 19" fill="none" onClick={handleSvgClick}>
