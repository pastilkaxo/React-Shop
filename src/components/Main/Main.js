          ...
          .map((bike) => (
            <div className="card" key={bike.id}>
              <div className="bike-favorite">
                                      <svg onClick={() => { addFavBtn(bike);}} className="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium css-vubbuv" focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="FavoriteBorderIcon"  fill={bikeFillColors[bike.id - 1]}>
